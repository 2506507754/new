                    ...
                    <tr>
                        ...
                        <td width="90%" valign=top><p>&nbsp;</p>
                            <table width="75%" border=0 align="right" cellpadding=0 cellspacing=0>
                                ...
                                <tr align=middle>
                                    <td height=20
                                        align=right class=STYLE1>密&nbsp;&nbsp;码：</td>
                                ...
                                <tr align=middle>
                                    <td height=20 colspan=2 align="center"><input class=button_new value="登 录" type=submit name=Submit2 onClick="javascript:location.href='${pageContext.request.contextPath}/Homemaking/manageSvl?reqType=openMain'">
                                        &nbsp; &nbsp;
