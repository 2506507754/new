...
<head>
    ...
    <script language="JavaScript">
        function doDBClick(url,operator,type) {
            ...
            if (operator == false) {
                document.form.action = url + "&op=view";
...
<form action="${pageContext.request.contextPath}/Homemaking/manageSvl?reqType=addCustomer" method="post" >
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
    ...
    <tr>
        ...
        <td colspan="2" align="left" bgcolor="#FFFFFF">从
            <input name="textarea20" type="text" id="textarea11" value="" size="8" class="pi">
            到
    ...
    <tr>
        ...
        <td colspan="7" bgcolor="#FFFFFF">
            ...
            月嫂&nbsp;&nbsp;
            <input type="checkbox" name="checkbox4" id="checkbox4" value="2"/>
            保姆&nbsp;&nbsp;
            <input type="checkbox" name="checkbox4" id="checkbox4" value="3"/>
            钟点&nbsp;&nbsp;
            <input type="checkbox" name="checkbox4" id="checkbox4" value="4"/>
            厨嫂
            <input type="checkbox" name="checkbox4" id="checkbox" value="5"/>
            清洁工
            &nbsp;
            <input type="checkbox" name="checkbox4" id="checkbox" value="6"/>
            护工&nbsp;&nbsp;
            <input type="checkbox" name="checkbox4" id="checkbox" value="7"/>
            早教
            &nbsp;&nbsp;
            <input type="checkbox" name="checkbox4" id="checkbox" value="8"/>
            家教
            &nbsp;&nbsp;
            <input type="checkbox" name="checkbox4" id="checkbox2" value="9"/>
            高级管家<br>
            备注：
            <input name="textarea24" type="text" id="textarea9" value="" size="40" class="pi"></td>
    </tr>
    <tr>
